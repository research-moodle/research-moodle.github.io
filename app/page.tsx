...
import { data } from "./_internship-data";
      ...
      <div className="w-full bg-[#f5f5f5] flex flex-col items-center min-h-[85vh]">
        <div className='w-full border border-black h-44 lg:h-56 bg-[url("https://mveo.github.io/assets/imgs/header.jpg")] bg-no-repeat bg-cover bg-center'>
          <div className="w-full h-full bg-black/50 flex justify-center items-center text-white text-xl lg:text-4xl font-semibold">
            <h2 className="py-1 border-b border-white max-w-xs text-3xl lg:max-w-4xl text-center">
              Internship offer
            </h2>
          </div>
        </div>
        <div className="w-full md:w-3/4 lg:w-4/5 xl:w-3/5 p-5 px-5 md:px-6 lg:px-8">
          ...
          <p className="py-2 text-sm lg:text-base lg:px-3 text-justify text-black text-opacity-80">
              ...
              <table className="w-full text-sm lg:text-base lg:w-4/5 lg:ml-3">
                <tbody>
                  <tr className="border-b border-black">
                    ...
                    <th className="p-2 border-l border-black">
                      Tentative Timeline
                    </th>
                  </tr>
                  ...
                  <li key={index} className="py-1 text-black text-opacity-80">
                    <div
                      dangerouslySetInnerHTML={{
                        __html: DOMPurify.sanitize(eligibility),
                      }}
                    />
                  </li>
                ))}
          ...
          {data &&
            ...
            data.selectionProcedure.length > 0 && (
              <>
                ...
                <ul className="list-disc text-sm lg:text-base text-justify px-5 lg:px-8 p-2">
                  {data.selectionProcedure.map((procedure, index) => (
                    <li key={index} className="py-1 text-black text-opacity-80">
                      <div
                        dangerouslySetInnerHTML={{
                          __html: DOMPurify.sanitize(procedure),
                        }}
                      />
                    </li>
                  ))}
          ...
          {data && (
            <>
              ...
              <div className="mt-3 px-3 p-1 text-black text-sm lg:text-base text-opacity-80">
                ...
                {!data.open ? (
                  <i className="text-black text-opacity-60">
                    Currenty not accepting applications
                  </i>
                ) : (
                  <a
                    className="text-blue-600 text-opacity-80 hover:underline hover:cursor-pointer"
                    target="_blank"
              ...
              <InternshipProfilesSection
                title=""
                profiles={data.profiles.filter(
                  (i) => i.category === ProfileCategory.InternshipMentor
                )}
              />
              ...
              <InternshipProfilesSection
                ...
                profiles={data.profiles
                  .filter(
                    (i) =>
                      i.category === ProfileCategory.CurrentStudent &&
                      i.collegeTier
                  )
                  .reverse()}
              />
              ...
              <InternshipProfilesSection
                ...
                profiles={data.profiles.filter(
                  (i) =>
                    i.category === ProfileCategory.PreviousStudent &&
                    i.collegeTier
                )}
              />
              <InternshipProfilesSection
